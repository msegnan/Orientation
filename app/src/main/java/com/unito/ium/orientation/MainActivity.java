    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        if (mGravity != null && mMagnetic != null)
        {
            if (SensorManager.getRotationMatrix(mRotationMatrix, null, mGravity, mMagnetic))
            {
                ...
                pitch = orientation[1];
                roll = orientation[2];
                int direz = (int) (azimut *57);
                String punta = "";
                if (direz >-45 && direz < 45){
                    punta = "NORD";
                } else   if (direz >45 && direz < 135){
                    punta = "EST";
                } else   if (direz < -45 && direz > -135){
                    punta = "OVEST";
                }  else {
                ...
                ((TextView)findViewById(R.id.azimut)).setText("Azimut: "+(int)(FROM_RADS_TO_DEGS*azimut)+" "+punta);
